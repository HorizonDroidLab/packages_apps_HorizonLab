...
package com.horizon.lab.category.theme;
 ...
 public class Monet extends SettingsPreferenceFragment {

     final static String TAG = "Monet";
     ...
     public static void reset(Context mContext) {
         ...
         Settings.Secure.putIntForUser(resolver,
                 PREF_COLOR_OVERRIDE, 0, UserHandle.USER_CURRENT);
         Settings.Secure.putIntForUser(resolver,
                 PREF_CUSTOM_BGCOLOR, 0, UserHandle.USER_CURRENT);
         Settings.Secure.putIntForUser(resolver,
                 PREF_BGCOLOR_OVERRIDE, 0, UserHandle.USER_CURRENT);
     }
